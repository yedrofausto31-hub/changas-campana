...
export default function ChangasCampana() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans selection:bg-blue-600 selection:text-white">
      ...
      {/* HEADER ELEGANTE CON AZUL OSCURO Y SLATE */}
      <header className="bg-slate-900/95 backdrop-blur-md text-white sticky top-0 z-50 shadow-xl border-b border-slate-800 transition-all">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          >
            <div className="bg-blue-600 p-2.5 rounded-2xl text-white font-bold text-xl shadow-md group-hover:rotate-6 transition-transform">📍</div>
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-medium tracking-widest uppercase">Portal Local de Trabajos</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {esAdmin && (
              <button
                ...
                className="bg-red-600 hover:bg-red-700 active:scale-95 text-white font-black px-3.5 py-2 rounded-full text-xs flex items-center gap-1.5 shadow-md shadow-red-900/20 border border-red-400/30 animate-pulse transition-all"
              >
                <span>🛡️</span>
            ...
            <button
              ...
              className="bg-slate-800/80 text-slate-200 border border-slate-700 hover:bg-slate-700 hover:text-white active:scale-95 font-bold px-3.5 py-2 rounded-full text-xs flex items-center gap-1.5 shadow-sm transition-all"
            >
              <span>❓</span>
            ...
            {usuario && (
              <button
                ...
                className="bg-slate-800/80 text-slate-200 border border-slate-700 hover:bg-slate-700 hover:text-white active:scale-95 font-bold px-3.5 py-2 rounded-full text-xs flex items-center gap-1.5 shadow-sm transition-all relative"
              >
                <span>📌</span>
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-500 text-white active:scale-95 font-black px-4 py-2 rounded-full text-xs shadow-md shadow-blue-600/20 hover:shadow-blue-600/30 transition-all"
            >
              PUBLICAR
            </button>
            ...
            {usuario ? (
              <div className="flex items-center gap-2 border-l border-slate-800 pl-3">
                <button
                  ...
                  className="bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500 hover:from-amber-400 hover:to-yellow-300 text-slate-950 font-black px-3.5 py-2 rounded-full text-xs flex items-center gap-1.5 shadow-md shadow-amber-500/20 active:scale-95 transition-all"
                >
                  <span>👑</span>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-800/80 hover:bg-slate-700 text-slate-200 font-bold px-3 py-1.5 rounded-full text-xs border border-slate-700 transition-all active:scale-95"
                  title="Mis publicaciones"
                >
                  <span>📋</span>
                  <span className="hidden md:inline">MIS PUBLICACIONES</span>
                  <span className="bg-blue-600 text-white rounded-full text-[10px] px-1.5 py-0.2 font-black shadow-sm">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-slate-800/60 hover:bg-slate-700/80 px-3 py-1.5 rounded-full border border-slate-700 transition-all active:scale-95"
                >
                  <img src={usuario.avatar} alt="Perfil" className="w-6 h-6 rounded-full object-cover bg-slate-300 border border-slate-500" />
                  <span className="text-xs font-bold text-white max-w-[80px] truncate">{usuario.nombre}</span>
                </button>
              </div>
            ) : (
              <div className="flex items-center gap-2 border-l border-slate-800 pl-3">
                <button
                  ...
                  className="text-xs font-bold text-white border border-slate-700 px-3 py-2 rounded-full hover:bg-slate-800 active:scale-95 transition-all"
                >
                  Iniciar sesión
                </button>
                <button
                  onClick={() => setModalRegistro(true)}
                  className="text-xs font-bold bg-white text-slate-900 px-3.5 py-2 rounded-full hover:bg-slate-200 shadow-sm active:scale-95 transition-all"
                >
                  Registrarse
                </button>
              </div>
      ...
      {/* HERO CON FONDO SLATE Y AZUL NOCTURNO */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white py-14 px-4 shadow-inner">
          ...
          <div className="flex gap-2 max-w-md pt-2">
            <div className="relative w-full">
              <input
                ...
                className="w-full bg-white/95 backdrop-blur-md text-slate-900 pl-4 pr-10 py-3.5 rounded-2xl text-sm shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-500/30 transition-all placeholder:text-slate-400"
              />
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
        <section className="lg:col-span-3 space-y-6">
          <div className="flex justify-between items-center border-b border-slate-200 pb-3">
            <h3 className="text-xl font-black text-slate-900 tracking-tight">PUBLICACIONES DE LA COMUNIDAD</h3>
            <span className="text-xs bg-slate-200 text-slate-800 font-bold px-3 py-1 rounded-full border border-slate-300 shadow-sm">
          ...
          {!isLoaded ? (
            ...
            <div className="bg-white p-12 rounded-3xl text-center border border-slate-200/80 shadow-sm space-y-4">
              <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mx-auto text-3xl shadow-inner">📢</div>
              <h4 className="text-lg font-black text-slate-800">Todavía no hay publicaciones</h4>
              <p className="text-slate-500 text-xs max-w-sm mx-auto leading-relaxed">
                Sé el primero en ofrecer un servicio o buscar trabajadores en la zona de Campana.
              </p>
              <button
                onClick={handleAbrirPublicar}
                className="bg-blue-600 text-white font-black px-6 py-3 rounded-full text-xs shadow-md hover:bg-blue-500 hover:shadow-lg active:scale-95 transition-all mt-2"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {changasFiltradas.map((changa) => {
                ...
                return (
                  <div
                    key={changa.id}
                    className={`group relative bg-white rounded-2xl p-5 transition-all duration-300 flex flex-col justify-between space-y-4 ${
                      esFijada
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mb-3 pr-8">
                        <img
                          ...
                          className="w-10 h-10 rounded-full object-cover border border-slate-300 bg-slate-100 shrink-0 shadow-sm"
                        />
        ...
        <aside className="space-y-6">
          <div className="sticky top-20 bg-white rounded-3xl p-6 shadow-sm border border-slate-200/80 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all"
              >
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5 max-h-56 overflow-y-auto pr-1 select-none custom-scrollbar">
      ...
      {modalPremium && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[75]">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100 max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-amber-50 border border-amber-200/80 p-3 rounded-2xl text-center">
                  ...
                  <p className="text-sm font-black text-amber-600 mt-1">$1.500</p>
                </div>
                <div className="bg-amber-50 border border-amber-200/80 p-3 rounded-2xl text-center relative overflow-hidden">
                  <span className="absolute top-0 right-0 bg-amber-500 text-[8px] font-black text-slate-950 px-1.5 py-0.2 rounded-bl">POPULAR</span>
                  <p className="text-xs font-black text-amber-900">1 SEMANA</p>
                  <p className="text-sm font-black text-amber-600 mt-1">$3.000</p>
                </div>
                <div className="bg-amber-50 border border-amber-200/80 p-3 rounded-2xl text-center">
                  <p className="text-xs font-black text-amber-900">1 MES</p>
                  <p className="text-sm font-black text-amber-600 mt-1">$6.500</p>
                </div>
              </div>
            </div>
      ...
      {changaReportando && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[85] transition-opacity">
          <form onSubmit={handleEnviarReporte} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100 transform transition-all">
            <div className="flex justify-between items-center border-b pb-3">
            ...
            <div className="bg-amber-50 border border-amber-200/60 p-3.5 rounded-2xl text-xs text-amber-900 font-medium">
      ...
      {modalAdminPanel && esAdmin && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[90]">
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 space-y-4 shadow-2xl max-h-[85vh] flex flex-col border border-slate-100">
            <div className="flex justify-between items-center border-b pb-3">
              <h3 className="font-black text-xl text-red-600 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200/80">
                <p className="text-3xl font-black text-slate-900">{changas.length}</p>
                <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Publicaciones Totales</p>
              </div>
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200/80">
                <p className="text-3xl font-black text-slate-900">{usuariosRegistrados.length}</p>
                <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Usuarios Registrados</p>
              </div>
            </div>
              ...
              {usuariosRegistrados.map((u, i) => (
                <div key={i} className="border border-slate-200 rounded-2xl p-3.5 flex justify-between items-center gap-2 bg-slate-50/50">
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-slate-500">{u.email} - Barrio: {u.barrio}</p>
                  </div>
      ...
      {changaEditando && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[70] overflow-y-auto">
          <form onSubmit={guardarEdicionAviso} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-3 shadow-2xl my-8 border border-slate-100">
            <div className="flex justify-between items-center border-b pb-3">
              <h3 className="font-black text-xl text-slate-900">✏️ Editar Aviso</h3>
              <button
                type="button"
            ...
            <div className="grid grid-cols-3 gap-1.5 pt-1">
              <button
                ...
                className={`py-2 text-[11px] font-bold rounded-xl border transition-all active:scale-95 ${
              ...
              <button
                ...
                className={`py-2 text-[10px] font-bold rounded-xl border transition-all active:scale-95 ${
      ...
      {modalAyuda && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[70]">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl max-h-[85vh] flex flex-col border border-slate-100">
            <div className="flex justify-between items-center border-b pb-3">
            ...
            <div className="overflow-y-auto space-y-3.5 flex-1 pr-1 text-xs text-slate-700 leading-relaxed custom-scrollbar">
            ...
            <div className="overflow-y-auto space-y-3 flex-1 pr-1 custom-scrollbar">
              {misPublicaciones.length === 0 ? (
                ...
                misPublicaciones.map((ch) => (
                  <div key={ch.id} className="border border-slate-200 rounded-2xl p-4 flex items-center justify-between gap-3 bg-slate-50/50">
                    <div className="space-y-1 flex-1 min-w-0">
                      <h4 className="font-extrabold text-slate-800 text-xs truncate">{ch.titulo}</h4>
                      <p className="text-[11px] text-slate-500">📍 {ch.barrio} | 🔨 {ch.categoria}</p>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="text-xs font-bold text-blue-700 bg-blue-50 border border-blue-200 px-3 py-1.5 rounded-xl hover:bg-blue-100 active:scale-95 transition-all"
                      >
                        EDITAR
                      </button>
                      <button
                        onClick={() => eliminarMiPublicacion(ch.id)}
                        className="text-xs font-bold text-red-600 bg-red-50 border border-red-200 px-3 py-1.5 rounded-xl hover:bg-red-100 active:scale-95 transition-all"
                      >
                        ELIMINAR
                      </button>
                    </div>
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100">
            <div className="flex items-center gap-3 border-b pb-3">
              <img
                ...
                className="w-12 h-12 rounded-full object-cover border-2 border-slate-900 shrink-0 shadow-sm"
              />
              <div className="min-w-0">
                <h4 className="text-sm font-black text-slate-900 truncate">👤 {changaDetalle.usuarioNombre}</h4>
                <span className="inline-block text-[10px] font-bold text-slate-700 uppercase bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-md mt-0.5">
            ...
            <div className="space-y-2">
              <h3 className="font-black text-lg text-slate-900 leading-snug">{changaDetalle.titulo}</h3>
      ...
      {modalPublicar && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <form onSubmit={agregarChanga} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-3 shadow-2xl my-8 border border-slate-100">
            <h3 className="font-black text-xl text-slate-900">Publicar Changa en Campana</h3>
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        {item.eliminado ? (
                          <button
                            ...
                            className="text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-xl shrink-0 shadow-sm active:scale-95 transition-all"
                          >
                            RESTAURAR
                          </button>
                        ) : (
                          <button
                            ...
                            className="text-xs font-bold text-red-600 bg-red-50 border border-red-200 px-3 py-1.5 rounded-xl shrink-0 hover:bg-red-100 active:scale-95 transition-all"
                          >
                            BORRAR
                          </button>
                        )}
                      ...
                      {item.eliminado && (
                        <div className="mt-3 pt-2.5 border-t border-red-200/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1 text-[11px] text-red-600 font-semibold">
                          <span>¡Tiempo hasta que se borre definitivamente!</span>
      ...
      {modalRegistro && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <form onSubmit={handleRegistro} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-3 shadow-2xl border border-slate-100">
            <h3 className="font-black text-xl text-slate-900">Crear Cuenta</h3>
      ...
      {modalLogin && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <form onSubmit={handleLogin} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100">
            <h3 className="font-black text-xl text-slate-900">Iniciar Sesión</h3>
      ...
      {modalAjustes && usuario && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl text-center border border-slate-100">
            <h3 className="font-black text-xl text-slate-900">Mi Cuenta</h3>
            ...
            <div className="text-left bg-slate-50 p-4 rounded-2xl border border-slate-200/80 text-xs space-y-1.5">
              <p><strong>Nombre:</strong> {usuario.nombre}</p>
              <p><strong>Email:</strong> {usuario.email}</p>
              <p><strong>Barrio:</strong> {usuario.barrio}</p>
            </div>
      ...
      <footer className="bg-slate-950 text-slate-400 py-8 text-center text-xs mt-16 border-t border-slate-800">
